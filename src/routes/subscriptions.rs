...
// subscribe remains in charge of generating HTTP response to incoming request.
pub async fn subscribe(
    ...
    // A mutable reference to `Transaction` implement's sqlx's `Executor` trait
    // and can be used to run queries.
...
/// Generate a random 25-char case-sensitive subscription token.
